...
apt-get update
apt-get -y install mlocate git systemd-timesyncd gettext python-dev-is-python3 python3-dev nginx mysql-server mysql-client libssl-dev default-libmysqlclient-dev memcached python3-memcache htop libffi-dev libxml2-dev libxslt1-dev python3-lxml fail2ban 
